return @(
  ...
  "configure --console --instance HANode --upgradeCheck True --upgradeCheckWithStatistics False --webListenPrefixes http://localhost:82 --commsListenPort 10935 --webForceSSL False --hstsEnabled False --hstsMaxAge 3600",
