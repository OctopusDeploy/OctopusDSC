return @(
  ...
  "configure --console --instance OctopusServer --upgradeCheck True --upgradeCheckWithStatistics False --webListenPrefixes http://localhost:82 --commsListenPort 10935 --webForceSSL False --autoLoginEnabled False --hstsEnabled False --hstsMaxAge 3600",
