return @(
  ...
  "configure --console --instance OctopusServer --upgradeCheck True --upgradeCheckWithStatistics False --webListenPrefixes http://localhost:81 --commsListenPort 10935 --webForceSSL False --hstsEnabled False --hstsMaxAge 3600",
