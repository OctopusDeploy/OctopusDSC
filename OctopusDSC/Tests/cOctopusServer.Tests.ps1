        ...
        Describe 'cOctopusServer' {
            ...
            Context "Running HA" {
                It 'Should call expected commands on octopus.server.exe' {
                    ...
                    Assert-MockCalled -CommandName 'Invoke-OctopusServerCommand' -Times 1 -Exactly -ParameterFilter { ($arguments -join ' ') -eq "configure --console --instance HANode --upgradeCheck True --upgradeCheckWithStatistics False --webForceSSL False --hstsEnabled False --hstsMaxAge 3600 --webListenPrefixes $($haparams['WebListenPrefix']) --commsListenPort 10935 --autoLoginEnabled False" }
            ...
            Context "Run-on-server user - new install" {
                It 'Should call expected commands on octopus.server.exe' {
                    ...
                    Assert-MockCalled -CommandName 'Invoke-OctopusServerCommand' -Times 1 -Exactly -ParameterFilter { ($arguments -join ' ') -eq "configure --console --instance OctopusServer --upgradeCheck True --upgradeCheckWithStatistics False --webForceSSL False --hstsEnabled False --hstsMaxAge 3600 --webListenPrefixes $($haparams['WebListenPrefix']) --commsListenPort 10935 --autoLoginEnabled False" }
