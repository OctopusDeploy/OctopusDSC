describe "server remove second node" {
  ...
  it "the service 'OctopusDeploy: HANode' should not be installed" {
    (Get-Service 'OctopusDeploy: HANode' -ErrorAction SilentlyContinue) | Should -be $null
  }
