describe "server upgrade" {
  ...
  it "should have installed a newer version of 'C:/Program Files/Octopus Deploy/Octopus/Octopus.Server.exe'" {
    ...
    $preUpgradeVersion = (New-Object System.Version 3, 3, 24)
    $version.FileVersion | Should -BeGreaterThan $preUpgradeVersion
  }
